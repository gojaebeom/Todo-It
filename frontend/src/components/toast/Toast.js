...
const Toast = () => {
    ...
    return(
    toast.open &&
    <div className={`fixed right-10 top-10 flex items-center justify-between px-4 py-2 ${bgColor} rounded-sm shadow-lg min-w-200 animate-bounce z-50`}>
        ...
        <p className="mx-2 font-noto-light">{toast.message}</p>
