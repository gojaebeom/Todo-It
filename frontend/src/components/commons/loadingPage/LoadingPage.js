...
const LoadingPage = () => {
  ...
  return (
    loading.step2 && (
      <div
        className={` top-0 left-0 z-50 flex items-center justify-center w-full h-full transition-opacity delay-200 bg-red-300 ${
          loading.step1 ? 'opacity-100 fixed ' : 'opacity-0 absolute visible'
        }`}
      >
